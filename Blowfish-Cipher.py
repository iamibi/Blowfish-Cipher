...
class Blowfish(object):
    ...
    P_Box =  [0x243f6a88, 0x85a308d3, 0x13198a2e, 0x03707344, 
              0xa4093822, 0x299f31d0, 0x082efa98, 0xec4e6c89, 
              0x452821e6, 0x38d01377, 0xbe5466cf, 0x34e90c6c, 
              0xc0ac29b7, 0xc97c50dd, 0x3f84d5b5, 0xb5470917, 
              0x9216d5d9, 0x8979fb1b]
        
    S_Box = ([0xd1310ba6, 0x98dfb5ac, 0x2ffd72db, 0xd01adfb7, # sbox1
    ...
    def __init__(self, key, nonce=''):
        """ creates an instance of Blowfish and sets up the 
            ...
            key is a bytestring of between 8 and 56 bytes
            nonce is an optional bytestring of up to 8 bytes
        """
        if 8 < len(key) > 56:
            raise Exception('Key length not 8..56 bytes')
        
        # deep copy lest we modify class variables
        self.P = deepcopy(self.P_Box)
        self.S = deepcopy(self.S_Box)
    ...
    def _incr_counter(self):
        ...
        counter = [ch for ch in self.counter]
        counter[7] = chr((ord(counter[7])+1)&0xFF)
        if counter[7] == chr(0):
